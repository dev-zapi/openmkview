...
const TrashDialog: Component<TrashDialogProps> = (props) => {
  ...
  return (
    <Dialog open={props.isOpen} onOpenChange={(open) => { if (!open) props.onClose(); }}>
      <DialogContent class="trash-dialog">
        <div class="trash-header">
          ...
          <div class="trash-toolbar">
            ...
            <Button variant="ghost" size="icon" class="close-btn" onClick={props.onClose} aria-label="Close trash dialog">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              ...
              {(item) => (
                <li class="trash-item">
                  ...
                  <div class="trash-item-actions">
                    <Button variant="outline" size="sm" class="restore-btn" onClick={() => handleRestore(item)}>
                    ...
                    <Button variant="destructive" size="sm" class="delete-btn" onClick={() => setConfirmDelete(item)}>
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <line x1="18" y1="6" x2="6" y2="18"/>
                        <line x1="6" y1="6" x2="18" y2="18"/>
                      </svg>
        ...
        <Show when={confirmDelete()}>
          <div class="trash-confirm-overlay">
            <div class="trash-confirm-dialog">
              ...
              <DialogFooter class="trash-confirm-actions">
                <Button variant="outline" class="cancel-btn" onClick={() => setConfirmDelete(null)}>Cancel</Button>
                <Button variant="destructive" class="confirm-btn" onClick={handleDeleteConfirm}>Delete Forever</Button>
              </DialogFooter>
            </div>
          </div>
        </Show>
        ...
        <Show when={confirmClear()}>
          <div class="trash-confirm-overlay">
            <div class="trash-confirm-dialog">
              ...
              <p class="trash-confirm-warning">This action cannot be undone.</p>
              <DialogFooter class="trash-confirm-actions">
                <Button variant="outline" class="cancel-btn" onClick={() => setConfirmClear(false)}>Cancel</Button>
                <Button variant="destructive" class="confirm-btn" onClick={handleClearConfirm}>Clear All</Button>
              </DialogFooter>
            </div>
          </div>
        </Show>
